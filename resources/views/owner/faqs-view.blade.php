<x-owner-layout>
    ...
    <div class="py-4 bg-white mt-10 max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col justify-between lg:max-h-[calc(100vh-200px)] lg:overflow-y-auto ">
    ...
    @foreach ($faqs as $faq)
            ...
            <div class="mb-5">
                ...
                <div class="text-right mb-5">
                    <a href="{{route('ownereditfaqs', $faq->faq_id)}}" class="inline-flex w-16 items-center px-2 py-1 text-xs cursor-pointer font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                        Edit
                        <i class="fa-regular fa-pen-to-square ml-3"></i>
                    </a>
                    {{-- <a href="{{route('editfaqs', $faq->faq_id)}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-yellow-500 dark:hover:bg-yellow-800 dark:focus:ring-yellow-800 cursor-pointer">Edit</a> --}}
                    <a href="{{route('ownerdestroyfaqs', $faq->faq_id)}}" class="inline-flex w-20 items-center px-2 py-1 text-xs cursor-pointer font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                        Delete
