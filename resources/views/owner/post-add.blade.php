                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="md:col-span-5">
                                ...
                                <input type="text" name="description" id="description" class="h-10 border py-10 mt-1 rounded px-4 w-full bg-gray-50 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500 focus:ring-1"  value="" />
                                {{-- <script>
