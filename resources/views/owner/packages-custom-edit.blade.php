<x-owner-layout>
    ...
    <div class="absolute">
        <a href="{{ route('ownershowpackage', $package->package_id)}}">
    ...
    <form action="{{route('owner.custom.updatepackage', $package->package_id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("POST")
        <script>
