<x-admin-layout>
    ...
    <div class="absolute">
        <a href="{{route('showpackage', $package_id)}}">
    ...
    <div class="text-center py-2 my-2">
        ...
        <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Add <span class="text-yellow-600">Sample Photos</span>
        </h3>
                    ...
                    <div class="lg:col-span-2">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <input type="file" name="sampleimages[]" id="images" required class="h-10 border py-2 mt-1 rounded px-4 w-full bg-gray-50 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500 focus:ring-1" accept="image/*" multiple onchange="limitFiles(this, 4)"/>
                                <script>
                                    function limitFiles(input, maxFiles) {
                                        if (input.files.length > maxFiles) {
                                            // Prevent further file selection
                                            input.value = ''; 
                                            ...
                                            Swal.fire({
                                                ...
                                                text: 'You can only select a maximum of ' + maxFiles + ' files.',
