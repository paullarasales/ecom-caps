<x-admin-layout>
    ...
    <div class="text-center py-4 my-2">
        <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Pending <span class="text-yellow-600">Reviews</span> and <span class="text-yellow-600">Ratings</span>
        </h3>
    </div>
            ...
            <blockquote class="overflow-hidden h-full flex flex-col bg-white shadow rounded-xl">
                ...
                <footer class="flex items-center px-6 py-4 space-x-4 text-white bg-gray-700 justify-between">    
                    <div>
                        ...
                        <p href="" rel="noopener" class="text-sm text-gray-200">
                ...
                <div class="flex items-center px-6 py-4 space-x-4 text-white bg-gray-700 justify-between">
                    ...
                    <form action="{{ route('reviews.approve', $review->review_id) }}" method="POST">
                        @csrf
                        @method("PUT")
    ...
    @empty
        <p class="text-center text-gray-600">No pending reviews at the moment.</p>
    @endforelse
