<x-admin-layout>
    ...
    <div class="absolute">
        <a href="{{route('pendingView', $appointment->appointment_id)}}">
    ...
    <form action="{{route('newcustom.package.store.direct', $appointment->appointment_id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        <script>
    ...
    function displaySelectedItems() {
        ...
        if (selectedDessertOption && selectedDessertOption.dataset.price) {
            ...
            dessertDescription.textContent = formatter.format(dessertPrice); // Display the dessert and its price
