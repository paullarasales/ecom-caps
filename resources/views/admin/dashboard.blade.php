    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full min-w-0">
        ...
        <div class="flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
            <div class="flex flex-col items-center space-y-2">
                ...
                <div class="text-lg font-medium text-gray-700">Total Clients</div>
            </div>
        </div>
        ...
        <div class="flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
            <div class="flex flex-col items-center space-y-2">
                ...
                <div class="text-lg font-medium text-gray-700">Total Packages</div>
            </div>
        </div>
        ...
        <div class="flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
            <div class="flex flex-col items-center space-y-2">
                ...
                <div class="text-lg font-medium text-gray-700">Total Faqs</div>
            </div>
        </div>
        ...
        <div class="flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
            <div class="flex flex-col items-center space-y-2">
                ...
                <div class="text-lg font-medium text-gray-700">Total Post</div>
            </div>
        </div>
    </div>
            ...
            var chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        // {
                        //     label: 'Pending',
                        //     data: {!! json_encode($counts['pending']) !!},
