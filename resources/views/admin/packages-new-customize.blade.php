<x-admin-layout>
    ...
    <div class="flex flex-col items-center md:flex-row justify-center flex-wrap gap-3 mt-10">
        ...
        {{-- <div class="w-64 h-44">
            <div class="bg-white shadow-lg mx-auto border-b-4 border-slate-500 rounded-2xl overflow-hidden hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
                <div class="bg-slate-500 flex h-20 items-center">
                    <h1 class="text-white ml-4 border-2 py-2 px-4 rounded-full">
                        <i class="fa-solid fa-bowl-food"></i>
                    </h1>
                    <p class="ml-4 text-white uppercase font-semibold">Dish</p>
                </div>
                
                <div class="flex justify-center px-5 mb-2 text-sm">
                    <a href="{{ route('dish.index') }}">
                        <button type="button" class="border border-slate-500 text-slate-500 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-slate-600 focus:outline-none focus:shadow-outline">
                            Open
                        </button>
                    </a>
                </div>
