<x-manager-layout>
    <div class="absolute">
        <a href="{{route('manager.customsetup')}}">
    ...
    <div class="text-center py-2 my-2">
        ...
        <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Custom <span class="text-yellow-600">Setup Items</span>
        </h3>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 p-4">
        ...
        <div class="max-w-[12rem] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-3">
                <h5 class="mb-2 text-lg font-bold uppercase tracking-tight text-gray-900 dark:text-white">{{ $food->setupname }}</h5>
                <h5 class="mb-2 text-lg font-bold uppercase tracking-tight text-gray-900 dark:text-white">₱ {{ $food->setupprice }}</h5>

                <div class="flex justify-start gap-2">
                    <a href="{{route('manager.customsetup.edit', $food->setup_id)}}" class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                        Edit
                        {{-- <i class="fa-solid fa-arrow-right ml-3"></i> --}}
                    </a>
                    <a href="{{route('manager.customsetup.destroy', $food->setup_id)}}" class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                        Delete
                        {{-- <i class="fa-solid fa-arrow-right ml-3"></i> --}}
                    </a>
                </div>
