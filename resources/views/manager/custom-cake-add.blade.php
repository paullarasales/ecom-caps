<x-manager-layout>
    ...
    <div class="text-center py-2 my-2">
        ...
        <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Add <span class="text-yellow-600">Cake</span>
        </h3>

    </div>

    
    <form action="{{route('manager.customcake.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="bg-white rounded shadow-lg shadow-yellow-100 p-4 px-4 md:p-8 mb-6">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                            <div class="text-gray-600">
                                <p class="font-medium text-lg">Add Cake</p>
                        ...
                        <div class="lg:col-span-2">
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="cakename" id="cakename" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500 focus:ring-1" value="" />
                                </div>
    
                                <div class="md:col-span-2">
                                    <label for="cakeprice">Price</label>
                                    <input type="text" name="cakeprice" id="cakeprice" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500 focus:ring-1" value="" />
                                </div>
