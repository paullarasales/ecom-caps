        ...
        <aside class="bg-white text-black w-64 p-4 flex-shrink-0">
                ...
                <div class="flex flex-row items-start space-y-2 w-full">
                    <header>
                        ...
                        <div class="flex items-center justify-center">
                            <img src="{{ asset('images/sibsrbg.png')}}" alt="das" width="80px">
                        </div>
                    </header>
                </div>
            ...
            <nav class="flex flex-col mt-10 gap-3">
                <div class="{{ request()->routeIs('ownerdashboard') ? 'bg-gray-200' : '' }} flex items-center gap-2 rounded-sm h-12">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="{{ request()->routeIs('ownerdashboard') ? '#FFB200' : '#000000'}}" viewBox="0 0 24 24" stroke-width="1.5" class="ml-10 w-6 h-6">
                ...
                <div class="{{ request()->routeIs('ownerchat') ? 'bg-gray-200' : '' }} flex items-center gap-2 rounded-sm h-12">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="{{ request()->routeIs('ownerchat') ? '#FFB200' : '#000000'}}" viewBox="0 0 24 24" stroke-width="1.5" class="ml-10 w-6 h-6">
                ...
                <div class="{{ request()->routeIs('ownercalendar') ? 'bg-gray-200' : '' }} flex items-center gap-2 rounded-sm h-12">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="{{ request()->routeIs('ownercalendar') ? '#FFB200' : '#000000'}}" viewBox="0 0 24 24" stroke-width="1.5" class="ml-10 w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />                    
                    </svg>

                    <x-side-nav-link href="{{ route('ownercalendar') }}" :active="request()->routeIs('ownercalendar')" class="text-xl text-black font-medium mt-1 flex items-center w-full">
                        {{ __('Calendar')}}
                    </x-side-nav-link>
                </div>

                <div class="{{ request()->routeIs('ownerbooking') ? 'bg-gray-200' : '' }} flex items-center gap-2 rounded-sm h-12">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="{{ request()->routeIs('ownerbooking') ? '#FFB200' : '#000000'}}" viewBox="0 0 24 24" stroke-width="1.5" class="ml-10 w-6 h-6">
